...
export function ExpensesTab() {
  ...
  return (
    <div className="space-y-4 pb-20">
      <div className="bg-green-50 dark:bg-gray-900 rounded-lg border border-green-200 dark:border-gray-700 p-4 text-center">
        <p className="text-xs font-medium text-green-600 dark:text-green-400 uppercase tracking-wide">Total Session Cost</p>
      ...
      <div className="space-y-2">
        {sorted.map(expense => (
          <div key={expense.playerId} className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700">
            <button
            ...
            >
              <span className="font-medium text-gray-900 dark:text-gray-50">{expense.playerName}</span>
            ...
            {expandedPlayer === expense.playerId && (
              <div className="border-t border-gray-100 dark:border-gray-800 px-4 pb-3 pt-2 space-y-1">
                {expense.slotBreakdown.map(slot => (
                  <div key={slot.slotId} className="flex justify-between text-sm text-gray-500 dark:text-gray-400">
      ...
      <div className="fixed bottom-16 left-0 right-0 p-4 bg-gray-50 dark:bg-gray-950">
        <button
          onClick={handleShare}
