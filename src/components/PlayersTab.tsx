    ...
    <div className="space-y-4">
      {slots.length > 0 && (
        <div className="flex flex-wrap gap-2">
          {slotPlayerCounts.map(({ slot, count }) => (
            <span key={slot.id} className="text-xs bg-gray-100 dark:bg-gray-800 rounded-full px-3 py-1 text-gray-600 dark:text-gray-300">
      ...
      <ul className="space-y-2">
        {session.players.map(player => (
          <li key={player.id} className="flex items-center gap-2 bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-700 p-3">
              ...
              {sessionHours.length > 1 && (
                <div className="mt-1 flex items-center gap-1">
                  <select
                    ...
                    className="text-xs rounded border border-gray-200 dark:border-gray-700 px-1 py-0.5 text-gray-600 dark:text-gray-300 bg-white dark:bg-gray-900"
                  >
                    {sessionHours
            ...
            <button
              ...
              className="text-red-500 dark:text-red-400 hover:text-red-700 dark:hover:text-red-300 p-1 min-h-[44px] min-w-[44px] flex items-center justify-center"
